...
<body>
    <nav class="navigation_bar">
        ...
        <ul class="actions">
                ...
                <hr> <br>
                <li><a href="explorar.html"><img style="width:35px; height: 35px;" src="/BeBooks/assets/Imagens/lup.png" alt=""></a></li><p style="font-family: Inter; font-size: 1rem;">Explorar</p><br>  <br>
